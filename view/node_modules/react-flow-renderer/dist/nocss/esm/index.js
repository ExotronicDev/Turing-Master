import { _ as _slicedToArray, a as _defineProperty, P as Position, C as ConnectionMode, g as getHostForElement, u as useStoreApi, b as useStore, c as addEdge, d as getMarkerId, r as rectToBox, e as getConnectedEdges, f as getDimensions, h as PanOnScrollMode, i as clamp, j as getNodesInside, k as getSelectionChanges, l as getRectOfNodes, m as ConnectionLineType, M as MarkerType, n as isNumeric, o as Provider$1, p as createStore, q as applyEdgeChanges, s as applyNodeChanges } from './index-1cfd0ffe.js';
export { B as BackgroundVariant, m as ConnectionLineType, C as ConnectionMode, M as MarkerType, h as PanOnScrollMode, P as Position, c as addEdge, q as applyEdgeChanges, s as applyNodeChanges, e as getConnectedEdges, x as getIncomers, w as getOutgoers, l as getRectOfNodes, z as getTransformForBounds, v as isEdge, t as isNode, y as updateEdge, b as useStore, u as useStoreApi } from './index-1cfd0ffe.js';
import { _ as _toConsumableArray, a as _objectWithoutProperties, u as useReactFlow } from './useReactFlow-9fca72ec.js';
export { u as useReactFlow } from './useReactFlow-9fca72ec.js';
import cc from 'classcat';
import React, { memo, useRef, useState, useEffect, createContext, forwardRef, useContext, useCallback, useMemo } from 'react';
import shallow from 'zustand/shallow';
import { zoom, zoomIdentity } from 'd3-zoom';
import { select, pointer } from 'd3-selection';
import { DraggableCore } from 'react-draggable';
export { i as MiniMap } from './index-2f0babe4.js';
export { C as ControlButton, i as Controls } from './index-940301d1.js';
export { i as Background } from './index-4e6d5ad0.js';
export { u as useUpdateNodeInternals } from './useUpdateNodeInternals-b829e86d.js';
export { u as useNodes } from './useNodes-fa9cd400.js';
export { u as useEdges } from './useEdges-a68c1c54.js';
export { u as useViewport } from './useViewport-b9f42fd4.js';
import 'zustand';
...
function Attribution(_ref) {
  ...
  if (((proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-pro' || (proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-sponsor' || (proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-enterprise' || (proOptions === null || proOptions === void 0 ? void 0 : proOptions.account) === 'paid-custom') && proOptions !== null && proOptions !== void 0 && proOptions.hideAttribution) {
    return null;
  }
...
var wrapEdge = (function (EdgeComponent) {
  var EdgeWrapper = function EdgeWrapper(_ref) {
    ...
    var handleEdgeUpdater = useCallback(function (event, isSourceHandle) {
      ...
      onEdgeUpdateStart === null || onEdgeUpdateStart === void 0 ? void 0 : onEdgeUpdateStart(event, edgeElement, handleType);

      var _onEdgeUpdate = onEdgeUpdateEnd ? function (evt) {
        return onEdgeUpdateEnd(evt, edgeElement, handleType);
      } : undefined;
      ...
      onMouseDown(event, handleId, nodeId, store.setState, onConnectEdge, isTarget, isValidConnection, connectionMode, handleType, _onEdgeUpdate, store.getState);
...
var NodeRenderer = function NodeRenderer(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var nodeType = node.type || 'default'; // @ts-ignore
...
var ConnectionLine = (function (_ref) {
  ...
  if (!fromNode.current || !isConnectable || !((_fromNode$current$han = fromNode.current.handleBounds) !== null && _fromNode$current$han !== void 0 && _fromNode$current$han[connectionHandleType])) {
    return null;
  }
...
function groupEdgesByZLevel(edges, nodeInternals) {
  ...
  var levelLookup = edges.reduce(function (tree, edge) {
    ...
    if (elevateEdgesOnSelect) {
      ...
      z = hasZIndex ? edge.zIndex : Math.max(((_nodeInternals$get = nodeInternals.get(edge.source)) === null || _nodeInternals$get === void 0 ? void 0 : _nodeInternals$get.z) || 0, ((_nodeInternals$get2 = nodeInternals.get(edge.target)) === null || _nodeInternals$get2 === void 0 ? void 0 : _nodeInternals$get2.z) || 0);
    }
...
var EdgeRenderer = function EdgeRenderer(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, edgeTree.map(function (_ref) {
    ...
    }), renderConnectionLine && isMaxLevel && /*#__PURE__*/React.createElement(ConnectionLine, {
